...
COS_API_KEY_ID = "5dQovLKjDWicwnXlhH-Bn8eCXp3HZLwtGgK7VEtpOzdB" # eg "W00YixxxxxxxxxxMB-odB-2ySfTrFBIQQWanc--P3byk"
COS_INSTANCE_CRN = "crn:v1:bluemix:public:iam-identity::a/6dbe12d472834ce294b854718950995b::serviceid:ServiceId-765fff49-325d-48e5-b4b9-7256af56d5e5"
...
@app.route('/')
def index():
    files = get_bucket_contents('ibm-objectstorage12345')
